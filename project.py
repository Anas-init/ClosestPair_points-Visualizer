...
class Karatsuba(Tk):
    def __init__(self):
        ...
        chooseFileBtn = Button(self, text="Choose Input File", font=("Helvetica", 12), command=self.createTable, width=20)
        chooseFileBtn.place(relx=0.5, rely=0.02, anchor="n")
    ...
    def createTable(self):
        ...
        final_answer = self.applyKaratsuba(843874875548537, 4958495894485784);
